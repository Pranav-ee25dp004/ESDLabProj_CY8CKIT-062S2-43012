...
#define peri_0_div_16_15_GRP_NUM PERI_PCLK_PERIPHERAL_GROUP_NUM
...
#define CYBSP_CSD_CLK_DIV_GRP_NUM PERI_PCLK_PERIPHERAL_GROUP_NUM
#define CYBSP_CS_CLK_DIV_GRP_NUM CYBSP_CSD_CLK_DIV_GRP_NUM
